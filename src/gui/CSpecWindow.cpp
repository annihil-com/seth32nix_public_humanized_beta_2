...
void CSpecWindow::Display(void)
{
	...
	if (!Gui.InputActive() || eth32.cg.spectators[0][0]) {
		...
		Draw.Text(x + 5, yPos, GUI_FONTSCALE, "Spectator 3", GUI_FONTCOLOR2, qfalse, qfalse, GUI_FONT, true);
		yPos += GUI_FONTHEIGHT + GUI_TEXTSPACING;

		Draw.Text(x + 5, yPos, GUI_FONTSCALE, "Spectator 4", GUI_FONTCOLOR2, qfalse, qfalse, GUI_FONT, true);
		yPos += GUI_FONTHEIGHT + GUI_TEXTSPACING;
