...
Elf *CDetour::initElf(char *filename)
{
...
Elf_Scn *CDetour::getSection(Elf *elf, char *sectionName)
{
	GElf_Ehdr ehdr;
...
GElf_Shdr *CDetour::getSectionHeader(char *sectionName) {return getSectionHeader(NULL, sectionName);}
GElf_Shdr *CDetour::getSectionHeader(char *filename, char *sectionName)
{
	Elf *elf = initElf(filename);
...
bool CDetour::GOTHook(char *symbol, void *hook)
{
